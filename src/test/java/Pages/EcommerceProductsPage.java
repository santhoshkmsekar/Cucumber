...
public class EcommerceProductsPage extends BaseTest {

	@FindBy(xpath = "(//li[@class='nav-item li-change']//a)[6]")
	private WebElement Ecommerceproduct;
	...
	@FindBy(xpath = "//div[@class='product__price product__price--new ml-8']")
	...
	public EcommerceProductsPage(WebDriver driver) {
		BaseTest.driver = driver;
		PageFactory.initElements(driver, this);
	}

	public void Ecommerceproducts() {

		BaseClass.waittime(5);
		BaseClass.clickelement(Ecommerceproduct);
		...
		BaseClass.clickelement(Select_Ecommerce_Product);
