...
public class PassportSizePage extends BaseTest {
	...
	@FindBy(xpath = "//div[@class='d-flex pass-product-price']//h3")
	...
	@FindBy(xpath = "//div[@class='d-flex align-items-center mb-2']//h3[1]")
	private WebElement Order_Amount_Price;
	@FindBy(xpath = "//div[@class='d-flex align-items-center d_block']//h4[1]")
	...
	public PassportSizePage(WebDriver driver) {
		BaseTest.driver = driver;
		PageFactory.initElements(driver, this);
	}

	public void PassPort_Size_Order() throws InterruptedException, IOException {
		BaseClass.clickelement(PassportSizeButton);

		BaseClass.clickelement(PassportCard);

		Product_Name_Card = BaseClass.gettext(photo1);

		price = BaseClass.gettext(price_In_Card);

		BaseClass.clickelement(BrowseButton);

		BaseClass.clickelement(BackGroundColour);
		BaseClass.upload_file("C:\\Users\\Techno Genesis\\Desktop\\OLD\\File.jpg");

		// BaseClass.Assertion(toastmessage, "File has uploaded.");
		BaseClass.waittime(5);
		BaseClass.clickelement(BuynowButton);
