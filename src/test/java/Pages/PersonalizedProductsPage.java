...
public class PersonalizedProductsPage extends BaseTest {

	@FindBy(xpath = "//ul[@class = 'main-menu__list navbar-nav']//li[5]")
	private WebElement persoanlizedProduct;

	@FindBy(xpath = "(//span[text()='Category']/following::div[1]//div[1]//input)[4]")
	private WebElement category;

	@FindBy(xpath = "//span[text()='Frame Design']/following::i[1]")
	private WebElement Frame_Design;

	@FindBy(xpath = "(//span[text()='Frame Design']/following::div[1]//div[1]//input)[8]")
	private WebElement Select_Frame_Design;

	@FindBy(xpath = "//span[text()='Size']/following::i[1]")
	private WebElement Size;

	@FindBy(xpath = "(//span[text()='Size']/following::div[1]//div[1]//input)[5]")
	private WebElement Select_Size;

	@FindBy(xpath = "//span[text()='Material']/following::i[1]")
	private WebElement Material;

	@FindBy(xpath = "(//span[text()='Material']/following::div[1]//div[1]//input)[2]")
	private WebElement Select_Material;
	...
	@FindBy(xpath = "//div[contains(@class,'d-flex file-choose')]//div[1]")
	private WebElement upload;

	@FindBy(xpath = "(//div[@class='star-ratings']//h1)[1]")
	private WebElement Select_Personalized_Product;

	@FindBy(xpath = "((//label[text()='Search for'])[2]/following::input)[3]")
	private WebElement label1;

	@FindBy(xpath = "((//label[text()='Search for'])[2]/following::input)[4]")
	...
	public WebElement Product_Name_Card_Element;
	...
	public PersonalizedProductsPage(WebDriver driver) {
		BaseTest.driver = driver;
		PageFactory.initElements(driver, this);
	}

	public void persoanlizedpage() throws AWTException {
		// BaseClass.waittime(5);

		BaseClass.clickelement(persoanlizedProduct);

		BaseClass.clickelement(category);
		...
		BaseClass.clickelement(Select_Material);

		BaseClass.clickelement(Select_Personalized_Product);
		...
		BaseClass.sendkeys(label1, "Need good product");

		BaseClass.sendkeys(label3, "Need good product");
